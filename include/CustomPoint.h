...
template <class ContainerAllocator> struct CustomPoint_ {
  typedef CustomPoint_<ContainerAllocator> Type;

  CustomPoint_()
      : offset_time(0), x(0.0), y(0.0), z(0.0), reflectivity(0), tag(0),
        line(0) {}
...
struct MD5Sum<::livox_ros_driver::CustomPoint_<ContainerAllocator>> {
  ...
  static const char *
  value(const ::livox_ros_driver::CustomPoint_<ContainerAllocator> &) {
    return value();
  }
